...
export function setTotalCandidates(count) {
  totalCandidates = Number.isFinite(Number(count)) ? Number(count) : 0;
}
...
export function renderDashboard() {
  ...
  if (elements.statRow) {
    elements.statRow.innerHTML = `
      ...
      <div class="stat-card amber"><div class="num">${totalCandidates}</div><div class="label">Available Headcount</div></div>
      <div class="stat-card purple"><div class="num">${totalHeadcount}</div><div class="label">Headcount Requests</div></div>
